...
var _cyclicArray = require("../../helpers/cyclicArray");
...
class ListItems extends _react.Component {
  get addItemsLeft() {
    const _this$props = this.props,
          scrollItems = _this$props.scrollItems,
          direction = _this$props.direction;
    return direction === _constants.DIRECTIONS.prev ? scrollItems : ADD_ITEMS_LEFT;
  }
  ...
  get addItemsRight() {
    ...
    return direction === _constants.DIRECTIONS.next ? scrollItems : ADD_ITEMS_RIGHT;
  }
  ...
  get translateByDirection() {
    ...
    return direction === _constants.DIRECTIONS.prev ? itemWidth * scrollItems : -1 * itemWidth * scrollItems;
  }
  ...
  get preparedChildren() {
    ...
    return (0, _cyclicArray.cyclicArray)(children, currentIndex - this.addItemsLeft, currentIndex + showItemsCount + this.addItemsRight - 1);
  }
  ...
  cloneChildren(children, props) {
    return _react.Children.map(children, function (child, index) {
      return (0, _react.cloneElement)(child, _objectSpread({}, props, {
        key: index
      }));
    }, this);
  }
